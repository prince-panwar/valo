    ...
    <>
     <div className="container mx-auto bg-black  text-white flex flex-col items-center justify-center min-h-screen">
      <div className="form-box w-3/4 bg-white  text-black p-4 rounded-lg">
        ...
        <button type="button" className={`toggle-btn p-2 rounded ${isUGI ? 'font-bold  bg-black text-white' : ''}`} onClick={showUgi}>UGI</button>
<button type="button" className={`toggle-btn2 p-2 rounded ${!isUGI ? 'font-bold  bg-black text-white' : ''}`} onClick={showUgi}>Non-UGI</button>
        ...
        <form className="text-black" onSubmit={handleSubmit}>
          <input type="text" className="team-name block w-full p-2 mb-2 border border-black rounded" placeholder="Enter team name" required />
          <span className="fas fa-user"></span><br/>
          <label htmlFor="game" className="block mb-1">Select College:</label><br/>
          <select name="Select College"  className="college block w-full p-2 mb-2 border border-black rounded" id="College">
          ...
          <div className="form-section">
              ...
              <label htmlFor="valorant" className="mr-2">Valorant</label>
              ...
              <input type="radio" id="Single" onClick={(e)=>setPlayerType(e.target.value)}  name="game" value="Single" className="mr-1" />
              <label htmlFor="Single" className="mr-2">Single</label>
              <input type="radio" id="Multi" onClick={(e)=>setPlayerType(e.target.value)} name="game" value="Multi" className="mr-1" />
              ...
              <button type="submit" style={{marginTop: '27px', marginLeft: '67px'}} className="paynow bg-black text-white p-2 rounded">Pay Now</button>

          </div>
        </form>
      </div>
     
      <p className='text-red-500'> To complete the Registration make sure to fill the below given google form after you have done the payment</p>
      <a href="https://drive.google.com/drive/folders/119kbXH0nTSrMSoeD-i94P9nB3ACCoSKT" target="_blank" rel="noreferrer" className="text-blue-500">Click here to fill the form</a>
  ...
  <button style={{marginLeft:'115px'}} className="paynow"onClick={() => setIsModalOpen(false)}>Done</button>
</Modal>
